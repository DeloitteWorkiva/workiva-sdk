...
#   filename:  wdata.yaml
#   timestamp: 2026-03-05T18:19:23+00:00
...
class GlobalParameterDto(BaseModel):
    ...
    """
    list_type: Annotated[Optional[str], Field(alias='listType')] = None
    """
    If the parameter is of type select, this is the type of the select list. This is
    read only and is for identifying a static or entity select list.
    """
    ...
    """
    scope: Optional[Literal['global', 'local', 'system']] = None
    """
