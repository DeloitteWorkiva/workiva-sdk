"""Platform API — content namespace.
...
from workiva.models.platform_types import (
    CellRangeParam,
    ChangeSourceRangeParam,
    CreateDestinationRangeLinkParam,
    CreateSourceRangeLinkParam,
    DeleteColumnsParam,
    DeleteRowsParam,
    DuplicateTableParam,
    InsertColumnsParam,
    ...
    MoveColumnsParam,
    MoveRowsParam,
    RemoveDestinationRangeLinkParam,
    RemoveSourceRangeLinkParam,
    RichTextSelectionParam,
    TableCellsEditParam,
    TableLinksEditParam,
    TextEditParam,
    TextLinkEditParam,
...
class Content(BaseNamespace):
    ...
    def rich_text_anchor_creation(
        ...
        *,
        rich_text_id: str,
        revision: str,
        selection: RichTextSelection | RichTextSelectionParam,
        type_: str,
        timeout: Optional[float] = None,
        wait: Literal[False] = ...,
        wait_timeout: float = 300,
    ...
    def rich_text_duplication_edit(
        ...
        *,
        ...
        duplicate_table: Optional[DuplicateTable | DuplicateTableParam] = None,
        revision: Optional[str] = None,
        timeout: Optional[float] = None,
        wait: Literal[False] = ...,
        wait_timeout: float = 300,
    ...
    def rich_text_batch_edit(
        ...
        *,
        rich_text_id: str,
        data: list[TextEdit | TextEditParam],
    ...
    def rich_text_links_batch_edit(
        ...
        *,
        rich_text_id: str,
        data: list[TextLinkEdit | TextLinkEditParam],
    ...
    def table_anchor_creation(
        ...
        *,
        table_id: str,
        range: CellRange | CellRangeParam,
        revision: str,
        timeout: Optional[float] = None,
        wait: Literal[False] = ...,
        wait_timeout: float = 300,
    ...
    def table_cells_batch_edit(
        ...
        *,
        table_id: str,
        data: list[TableCellsEdit | TableCellsEditParam],
    ...
    def table_edit(
        ...
        *,
        ...
        delete_columns: Optional[DeleteColumns | DeleteColumnsParam] = None,
        delete_rows: Optional[DeleteRows | DeleteRowsParam] = None,
        insert_columns: Optional[InsertColumns | InsertColumnsParam] = None,
        insert_rows: Optional[InsertRows | InsertRowsParam] = None,
        move_columns: Optional[MoveColumns | MoveColumnsParam] = None,
        move_rows: Optional[MoveRows | MoveRowsParam] = None,
        timeout: Optional[float] = None,
        wait: Literal[False] = ...,
        wait_timeout: float = 300,
    ) -> httpx.Response: ...
    ...
    def table_links_batch_edit(
        ...
        *,
        table_id: str,
        data: list[TableLinksEdit | TableLinksEditParam],
        locked_cell_edit_mode: Optional[str] = None,
        revision: Optional[str] = None,
        timeout: Optional[float] = None,
        wait: Literal[False] = ...,
    ...
    def table_range_links_edit(
        ...
        *,
        ...
        change_source_range: Optional[ChangeSourceRange | ChangeSourceRangeParam] = None,
        create_destination: Optional[
            CreateDestinationRangeLink | CreateDestinationRangeLinkParam
        ] = None,
        create_source: Optional[CreateSourceRangeLink | CreateSourceRangeLinkParam] = None,
        remove_destination: Optional[
            RemoveDestinationRangeLink | RemoveDestinationRangeLinkParam
        ] = None,
        remove_source: Optional[RemoveSourceRangeLink | RemoveSourceRangeLinkParam] = None,
        timeout: Optional[float] = None,
        wait: Literal[False] = ...,
        wait_timeout: float = 300,
    ) -> httpx.Response: ...
