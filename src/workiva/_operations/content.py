...
class Content(BaseNamespace):
    ...
    def rich_text_anchor_creation(
        ...
        *,
        rich_text_id: str,
        revision: str,
        selection: RichTextSelectionParam,
        type_: str,
        timeout: Optional[float] = None,
        wait: Literal[False] = ...,
        wait_timeout: float = 300,
    ...
    def rich_text_duplication_edit(
        ...
        *,
        ...
        duplicate_table: Optional[DuplicateTableParam] = None,
        revision: Optional[str] = None,
        timeout: Optional[float] = None,
        wait: Literal[False] = ...,
        wait_timeout: float = 300,
    ...
    def table_edit(
        ...
        *,
        ...
        delete_columns: Optional[DeleteColumnsParam] = None,
        delete_rows: Optional[DeleteRowsParam] = None,
        insert_columns: Optional[InsertColumnsParam] = None,
        insert_rows: Optional[InsertRowsParam] = None,
        move_columns: Optional[MoveColumnsParam] = None,
        move_rows: Optional[MoveRowsParam] = None,
        timeout: Optional[float] = None,
        wait: Literal[False] = ...,
        wait_timeout: float = 300,
    ) -> httpx.Response: ...
    ...
    def table_range_links_edit(
        ...
        *,
        ...
        change_source_range: Optional[ChangeSourceRangeParam] = None,
        create_destination: Optional[CreateDestinationRangeLinkParam] = None,
        create_source: Optional[CreateSourceRangeLinkParam] = None,
        remove_destination: Optional[RemoveDestinationRangeLinkParam] = None,
        remove_source: Optional[RemoveSourceRangeLinkParam] = None,
        timeout: Optional[float] = None,
        wait: Literal[False] = ...,
        wait_timeout: float = 300,
    ) -> httpx.Response: ...
