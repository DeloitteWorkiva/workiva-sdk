...
with SDK(
    ...
    res = sdk.test_forms.get_matrix_by_id(test_form_id="<id>", test_phase_id="<id>", matrix_id="<id>", expand="?$expand=relationships\n")
...
with SDK(
    ...
    res = sdk.test_forms.get_samples(test_form_id="<id>", test_phase_id="<id>", matrix_id="<id>", expand="?$expand=relationships\n")
