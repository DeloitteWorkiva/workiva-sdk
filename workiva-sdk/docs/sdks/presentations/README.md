...
with SDK(
    ...
    res = sdk.presentations.get_slide_layouts(presentation_id="<id>", revision="1A2B3C4D", maxpagesize=1000, next="JTI0bGltaXQ9MTAwJiUyNG9mZnNldD0xMDA")
...
with SDK(
    ...
    res = sdk.presentations.get_slides(presentation_id="<id>", revision="1A2B3C4D", maxpagesize=1000, next="JTI0bGltaXQ9MTAwJiUyNG9mZnNldD0xMDA")
