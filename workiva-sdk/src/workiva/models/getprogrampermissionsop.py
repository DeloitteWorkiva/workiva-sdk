...
class GetProgramPermissionsRequestTypedDict(TypedDict):
    program_id: str
...
class GetProgramPermissionsRequest(BaseModel):
...
class GetProgramPermissionsResponseTypedDict(TypedDict):
    result: ResourcePermissionsListResultTypedDict


class GetProgramPermissionsResponse(BaseModel):
    next: Union[
        Callable[[], Optional[GetProgramPermissionsResponse]],
        Callable[[], Awaitable[Optional[GetProgramPermissionsResponse]]],
    ]
