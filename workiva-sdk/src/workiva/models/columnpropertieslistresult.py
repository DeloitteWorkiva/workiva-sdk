...
from .tablecolumnproperties import TableColumnProperties, TableColumnPropertiesTypedDict
import pydantic
...
class ColumnPropertiesListResultTypedDict(TypedDict):
    r"""Data model for column properties list"""

    at_next_link: NotRequired[Nullable[str]]
    r"""Pagination link for next set of results"""
    data: NotRequired[List[TableColumnPropertiesTypedDict]]
    r"""The current page of column properties"""
...
try:
    ColumnPropertiesListResult.model_rebuild()
except NameError:
    pass
