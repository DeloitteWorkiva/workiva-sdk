...
class WdataGetRefreshBatchStatusRequestTypedDict(TypedDict):
    batch_id: str
    r"""The ID of the batch to return details about"""
    workspace_id: NotRequired[str]


class WdataGetRefreshBatchStatusRequest(BaseModel):
    batch_id: Annotated[
        str,
