...
class GetSpreadsheetsResponseTypedDict(TypedDict):
    result: SpreadsheetsListResultTypedDict


class GetSpreadsheetsResponse(BaseModel):
    next: Union[
        Callable[[], Optional[GetSpreadsheetsResponse]],
        Callable[[], Awaitable[Optional[GetSpreadsheetsResponse]]],
    ]

    result: SpreadsheetsListResult
