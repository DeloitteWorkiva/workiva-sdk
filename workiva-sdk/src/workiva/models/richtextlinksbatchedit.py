...
class RichTextLinksBatchEditTypedDict(TypedDict):
    r"""A collection of link edits to perform on rich text content."""

    data: List[TextLinkEditTypedDict]
    r"""The link edits to apply to rich text."""
...
class RichTextLinksBatchEdit(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = set(["isolateEdits", "revision"])
...
try:
    RichTextLinksBatchEdit.model_rebuild()
except NameError:
    pass
