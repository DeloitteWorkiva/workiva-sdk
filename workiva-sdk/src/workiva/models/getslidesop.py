...
class GetSlidesResponseTypedDict(TypedDict):
    result: SlidesListResultTypedDict


class GetSlidesResponse(BaseModel):
    next: Union[
        Callable[[], Optional[GetSlidesResponse]],
        Callable[[], Awaitable[Optional[GetSlidesResponse]]],
    ]
