...
from .workspaceslistresult import WorkspacesListResult, WorkspacesListResultTypedDict
import pydantic
...
class GetWorkspacesResponseTypedDict(TypedDict):
    result: WorkspacesListResultTypedDict


class GetWorkspacesResponse(BaseModel):
    next: Union[
        Callable[[], Optional[GetWorkspacesResponse]],
        Callable[[], Awaitable[Optional[GetWorkspacesResponse]]],
    ]

    result: WorkspacesListResult
