...
class GetDrawingAnchorExtensionsResponseTypedDict(TypedDict):
    result: AnchorExtensionsListResultTypedDict


class GetDrawingAnchorExtensionsResponse(BaseModel):
    next: Union[
        Callable[[], Optional[GetDrawingAnchorExtensionsResponse]],
        Callable[[], Awaitable[Optional[GetDrawingAnchorExtensionsResponse]]],
    ]
