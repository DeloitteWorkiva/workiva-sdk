...
class GetWorkspaceMembershipsRequestTypedDict(TypedDict):
    organization_id: str
...
class GetWorkspaceMembershipsRequest(BaseModel):
...
class GetWorkspaceMembershipsResponseTypedDict(TypedDict):
    result: WorkspaceMembershipsListResultTypedDict


class GetWorkspaceMembershipsResponse(BaseModel):
    next: Union[
        Callable[[], Optional[GetWorkspaceMembershipsResponse]],
        Callable[[], Awaitable[Optional[GetWorkspaceMembershipsResponse]]],
    ]

    result: WorkspaceMembershipsListResult
