...
class GetSlideLayoutsRequestTypedDict(TypedDict):
    presentation_id: str
...
class GetSlideLayoutsRequest(BaseModel):
...
class GetSlideLayoutsResponseTypedDict(TypedDict):
    result: SlideLayoutsListResultTypedDict


class GetSlideLayoutsResponse(BaseModel):
    next: Union[
        Callable[[], Optional[GetSlideLayoutsResponse]],
        Callable[[], Awaitable[Optional[GetSlideLayoutsResponse]]],
    ]

    result: SlideLayoutsListResult
