...
class GetTableAnchorExtensionsResponseTypedDict(TypedDict):
    result: AnchorExtensionsListResultTypedDict


class GetTableAnchorExtensionsResponse(BaseModel):
    next: Union[
        Callable[[], Optional[GetTableAnchorExtensionsResponse]],
        Callable[[], Awaitable[Optional[GetTableAnchorExtensionsResponse]]],
    ]
