...
class GetTopicsResponseTypedDict(TypedDict):
    result: TopicsListResultTypedDict


class GetTopicsResponse(BaseModel):
    next: Union[
        Callable[[], Optional[GetTopicsResponse]],
        Callable[[], Awaitable[Optional[GetTopicsResponse]]],
    ]
