...
class HeaderPropertiesMarginTypedDict(TypedDict):
...
class HeaderPropertiesMargin(BaseModel):
    r"""Properties related to the margins of a header and footer"""
...
class HeaderPropertiesTypedDict(TypedDict):
    r"""Properties for header of a section"""
    ...
    margin: NotRequired[Nullable[HeaderPropertiesMarginTypedDict]]
    r"""Properties related to the margins of a header and footer"""
...
class HeaderProperties(BaseModel):
    ...
    margin: OptionalNullable[HeaderPropertiesMargin] = UNSET
    r"""Properties related to the margins of a header and footer"""
