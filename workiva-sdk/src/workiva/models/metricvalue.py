...
class ConnectionType(str, Enum, metaclass=utils.OpenEnumMeta):
...
class DataSource(BaseModel):
    ...
    def serialize_connection_type(self, value):
        if isinstance(value, str):
            try:
                return models.ConnectionType(value)
            except ValueError:
                return value
        return value
...
class MetricValueStatus(str, Enum, metaclass=utils.OpenEnumMeta):
...
class MetricValue(BaseModel):
    ...
    def serialize_status(self, value):
        if isinstance(value, str):
            try:
                return models.MetricValueStatus(value)
            except ValueError:
                return value
        return value
...
class MetricValueInputTypedDict(TypedDict):
    r"""Represents a metric value, which is a data record belonging to a specific metric."""
