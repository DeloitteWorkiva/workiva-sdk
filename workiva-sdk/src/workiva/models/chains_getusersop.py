...
class ChainsGetUsersRequestTypedDict(TypedDict):
...
class ChainsGetUsersRequest(BaseModel):
    page: Annotated[
        Optional[int],
...
class ChainsGetUsersResponseTypedDict(TypedDict):
    result: UsersResponseTypedDict


class ChainsGetUsersResponse(BaseModel):
    next: Union[
        Callable[[], Optional[ChainsGetUsersResponse]],
        Callable[[], Awaitable[Optional[ChainsGetUsersResponse]]],
    ]
