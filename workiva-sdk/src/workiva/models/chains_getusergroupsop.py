...
class ChainsGetUserGroupsResponseTypedDict(TypedDict):
    result: UserGroupsResponseTypedDict


class ChainsGetUserGroupsResponse(BaseModel):
    next: Union[
        Callable[[], Optional[ChainsGetUserGroupsResponse]],
        Callable[[], Awaitable[Optional[ChainsGetUserGroupsResponse]]],
    ]
