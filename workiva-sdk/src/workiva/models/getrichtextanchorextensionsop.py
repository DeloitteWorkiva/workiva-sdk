...
class GetRichTextAnchorExtensionsResponseTypedDict(TypedDict):
    result: AnchorExtensionsListResultTypedDict


class GetRichTextAnchorExtensionsResponse(BaseModel):
    next: Union[
        Callable[[], Optional[GetRichTextAnchorExtensionsResponse]],
        Callable[[], Awaitable[Optional[GetRichTextAnchorExtensionsResponse]]],
    ]

    result: AnchorExtensionsListResult
