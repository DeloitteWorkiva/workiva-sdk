...
class Iam(BaseSDK):
    ...
    def token_request(
        ...
        *,
        request: Optional[
            Union[
                models.TokenRequestRequestBody, models.TokenRequestRequestBodyTypedDict
            ]
        ] = None,
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, Optional[models.TokenRequestRequestBody])
        request = cast(Optional[models.TokenRequestRequestBody], request)
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, True, "form", Optional[models.TokenRequestRequestBody]
            ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.BearerToken, http_res)
        if utils.match_response(http_res, ["400", "401"], "application/json"):
            response_data = unmarshal_json_response(errors.IamErrorData, http_res)
            raise errors.IamError(response_data, http_res)
