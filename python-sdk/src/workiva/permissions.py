...
class Permissions(BaseSDK):
    ...
    def get_permission_by_id(
        ...
        *,
        ...
        r"""Retrieve a single permission

        Retrieves a permission given its ID


        :param permission_id: The unique identifier of the permission
        ...
        request = models.GetPermissionByIDRequest(
    ...
    def get_permissions(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.PermissionsListResult:
        r"""Retrieve a list of all available permissions
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.PermissionsListResult, http_res)
        if utils.match_response(
            http_res, ["400", "401", "403", "404", "409", "429"], "application/json"
        ):
            response_data = unmarshal_json_response(errors.ErrorResponseData, http_res)
