...
class GetFilePermissionsRequest(BaseModel):
    file_id: Annotated[
        str,
...
class GetFilePermissionsResponseTypedDict(TypedDict):
    result: ResourcePermissionsListResultTypedDict


class GetFilePermissionsResponse(BaseModel):
    next: Union[
        Callable[[], Optional[GetFilePermissionsResponse]],
        Callable[[], Awaitable[Optional[GetFilePermissionsResponse]]],
    ]
