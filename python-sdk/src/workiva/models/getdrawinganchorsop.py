...
class GetDrawingAnchorsRequestTypedDict(TypedDict):
    drawing_id: str
...
class GetDrawingAnchorsRequest(BaseModel):
...
class GetDrawingAnchorsResponseTypedDict(TypedDict):
    result: AnchorsListResultTypedDict


class GetDrawingAnchorsResponse(BaseModel):
    next: Union[
        Callable[[], Optional[GetDrawingAnchorsResponse]],
        Callable[[], Awaitable[Optional[GetDrawingAnchorsResponse]]],
    ]
