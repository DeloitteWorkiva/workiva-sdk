...
class GetOrganizationActivitiesRequestTypedDict(TypedDict):
    organization_id: str
...
class GetOrganizationActivitiesResponseTypedDict(TypedDict):
    result: ActivitiesListResultTypedDict


class GetOrganizationActivitiesResponse(BaseModel):
    next: Union[
        Callable[[], Optional[GetOrganizationActivitiesResponse]],
        Callable[[], Awaitable[Optional[GetOrganizationActivitiesResponse]]],
    ]
