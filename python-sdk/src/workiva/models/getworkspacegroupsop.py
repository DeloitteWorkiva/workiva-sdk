...
class GetWorkspaceGroupsRequestTypedDict(TypedDict):
    organization_id: str
...
class GetWorkspaceGroupsResponseTypedDict(TypedDict):
    result: WorkspaceGroupsListResultTypedDict


class GetWorkspaceGroupsResponse(BaseModel):
    next: Union[
        Callable[[], Optional[GetWorkspaceGroupsResponse]],
        Callable[[], Awaitable[Optional[GetWorkspaceGroupsResponse]]],
    ]

    result: WorkspaceGroupsListResult
