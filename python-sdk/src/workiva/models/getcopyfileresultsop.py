...
class GetCopyFileResultsRequestTypedDict(TypedDict):
    operation_id: str
...
class GetCopyFileResultsRequest(BaseModel):
...
class GetCopyFileResultsResponseTypedDict(TypedDict):
    headers: Dict[str, List[str]]
    result: CopyFileListResultTypedDict


class GetCopyFileResultsResponse(BaseModel):
    next: Union[
        Callable[[], Optional[GetCopyFileResultsResponse]],
        Callable[[], Awaitable[Optional[GetCopyFileResultsResponse]]],
    ]

    headers: Dict[str, List[str]]

    result: CopyFileListResult
