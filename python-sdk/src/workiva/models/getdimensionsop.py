...
from .dimensionslistresult import DimensionsListResult, DimensionsListResultTypedDict
import pydantic
...
class GetDimensionsRequestTypedDict(TypedDict):
    program_id: str
...
class GetDimensionsResponseTypedDict(TypedDict):
    result: DimensionsListResultTypedDict


class GetDimensionsResponse(BaseModel):
    next: Union[
        Callable[[], Optional[GetDimensionsResponse]],
        Callable[[], Awaitable[Optional[GetDimensionsResponse]]],
    ]

    result: DimensionsListResult
