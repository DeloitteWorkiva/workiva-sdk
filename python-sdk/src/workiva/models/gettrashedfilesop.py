...
class GetTrashedFilesResponseTypedDict(TypedDict):
    result: FilesListResultTypedDict


class GetTrashedFilesResponse(BaseModel):
    next: Union[
        Callable[[], Optional[GetTrashedFilesResponse]],
        Callable[[], Awaitable[Optional[GetTrashedFilesResponse]]],
    ]
