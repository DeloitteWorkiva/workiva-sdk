...
class GetDocumentPermissionsRequestTypedDict(TypedDict):
    document_id: str
...
class GetDocumentPermissionsRequest(BaseModel):
...
class GetDocumentPermissionsResponseTypedDict(TypedDict):
    result: ResourcePermissionsListResultTypedDict


class GetDocumentPermissionsResponse(BaseModel):
    next: Union[
        Callable[[], Optional[GetDocumentPermissionsResponse]],
        Callable[[], Awaitable[Optional[GetDocumentPermissionsResponse]]],
    ]
