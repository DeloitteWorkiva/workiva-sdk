...
from workiva.utils import FieldMetadata, HeaderMetadata, QueryParamMetadata
...
class GetOrganizationsRequest(BaseModel):
    wk_service_provider: Annotated[
        str,
        pydantic.Field(alias="Wk-Service-Provider"),
...
class GetOrganizationsResponseTypedDict(TypedDict):
    result: OrganizationsListResultTypedDict


class GetOrganizationsResponse(BaseModel):
    next: Union[
        Callable[[], Optional[GetOrganizationsResponse]],
        Callable[[], Awaitable[Optional[GetOrganizationsResponse]]],
    ]

    result: OrganizationsListResult
