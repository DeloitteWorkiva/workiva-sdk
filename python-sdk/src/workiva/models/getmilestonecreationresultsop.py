...
class GetMilestoneCreationResultsRequest(BaseModel):
...
class GetMilestoneCreationResultsResponseTypedDict(TypedDict):
    result: MilestoneCreationListResultTypedDict


class GetMilestoneCreationResultsResponse(BaseModel):
    next: Union[
        Callable[[], Optional[GetMilestoneCreationResultsResponse]],
        Callable[[], Awaitable[Optional[GetMilestoneCreationResultsResponse]]],
    ]

    result: MilestoneCreationListResult
