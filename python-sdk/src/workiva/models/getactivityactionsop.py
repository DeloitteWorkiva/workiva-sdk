...
class GetActivityActionsResponseTypedDict(TypedDict):
    result: ActivityActionsListResultTypedDict


class GetActivityActionsResponse(BaseModel):
    next: Union[
        Callable[[], Optional[GetActivityActionsResponse]],
        Callable[[], Awaitable[Optional[GetActivityActionsResponse]]],
    ]

    result: ActivityActionsListResult
