...
class GetRangeLinkDestinationsResponseTypedDict(TypedDict):
    result: RangeLinkListResultTypedDict


class GetRangeLinkDestinationsResponse(BaseModel):
    next: Union[
        Callable[[], Optional[GetRangeLinkDestinationsResponse]],
        Callable[[], Awaitable[Optional[GetRangeLinkDestinationsResponse]]],
    ]
