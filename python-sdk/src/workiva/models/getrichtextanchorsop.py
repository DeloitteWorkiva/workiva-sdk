...
class GetRichTextAnchorsRequestTypedDict(TypedDict):
    rich_text_id: str
...
class GetRichTextAnchorsRequest(BaseModel):
...
class GetRichTextAnchorsResponseTypedDict(TypedDict):
    result: AnchorsListResultTypedDict


class GetRichTextAnchorsResponse(BaseModel):
    next: Union[
        Callable[[], Optional[GetRichTextAnchorsResponse]],
        Callable[[], Awaitable[Optional[GetRichTextAnchorsResponse]]],
    ]
