...
class GetRangeLinksRequestTypedDict(TypedDict):
    table_id: str
...
class GetRangeLinksRequest(BaseModel):
    table_id: Annotated[
        str,
...
class GetRangeLinksResponseTypedDict(TypedDict):
    result: RangeLinkListResultTypedDict


class GetRangeLinksResponse(BaseModel):
    next: Union[
        Callable[[], Optional[GetRangeLinksResponse]],
        Callable[[], Awaitable[Optional[GetRangeLinksResponse]]],
    ]

    result: RangeLinkListResult
