...
class GetSheetPermissionsResponseTypedDict(TypedDict):
    result: ResourcePermissionsListResultTypedDict


class GetSheetPermissionsResponse(BaseModel):
    next: Union[
        Callable[[], Optional[GetSheetPermissionsResponse]],
        Callable[[], Awaitable[Optional[GetSheetPermissionsResponse]]],
    ]
