...
class GetSectionPermissionsRequestTypedDict(TypedDict):
    document_id: str
...
class GetSectionPermissionsRequest(BaseModel):
...
class GetSectionPermissionsResponseTypedDict(TypedDict):
    result: ResourcePermissionsListResultTypedDict


class GetSectionPermissionsResponse(BaseModel):
    next: Union[
        Callable[[], Optional[GetSectionPermissionsResponse]],
        Callable[[], Awaitable[Optional[GetSectionPermissionsResponse]]],
    ]
