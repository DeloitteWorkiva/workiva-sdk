...
class GetProgramsResponseTypedDict(TypedDict):
    result: ProgramsListResultTypedDict


class GetProgramsResponse(BaseModel):
    next: Union[
        Callable[[], Optional[GetProgramsResponse]],
        Callable[[], Awaitable[Optional[GetProgramsResponse]]],
    ]

    result: ProgramsListResult
