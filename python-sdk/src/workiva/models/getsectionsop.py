...
class GetSectionsRequestTypedDict(TypedDict):
    document_id: str
...
class GetSectionsResponseTypedDict(TypedDict):
    result: SectionsListResultTypedDict


class GetSectionsResponse(BaseModel):
    next: Union[
        Callable[[], Optional[GetSectionsResponse]],
        Callable[[], Awaitable[Optional[GetSectionsResponse]]],
    ]

    result: SectionsListResult
