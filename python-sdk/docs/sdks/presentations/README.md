...
with SDK(
    ...
    res = sdk.presentations.get_slide_layouts(presentation_id="<id>", dollar_revision="1A2B3C4D", dollar_maxpagesize=1000, dollar_next="JTI0bGltaXQ9MTAwJiUyNG9mZnNldD0xMDA")
...
with SDK(
    ...
    res = sdk.presentations.get_slides(presentation_id="<id>", dollar_revision="1A2B3C4D", dollar_maxpagesize=1000, dollar_next="JTI0bGltaXQ9MTAwJiUyNG9mZnNldD0xMDA")
