...
with SDK(
    ...
    res = sdk.test_forms.get_test_phase_attachment_by_id(test_form_id="<id>", test_phase_id="<id>", attachment_id="<id>")
...
with SDK(
    ...
    res = sdk.test_forms.test_phase_attachment_download_by_id(test_form_id="<id>", test_phase_id="<id>", attachment_id="<id>")
...
with SDK(
    ...
    res = sdk.test_forms.test_phase_attachment_export_by_id(test_form_id="<id>", test_phase_id="<id>", attachment_id="<id>", graph_attachment_export={
...
with SDK(
    ...
    res = sdk.test_forms.get_matrix_by_id(test_form_id="<id>", test_phase_id="<id>", matrix_id="<id>", dollar_expand="?$expand=relationships\n")
...
with SDK(
    ...
    res = sdk.test_forms.matrix_attachment_upload(test_form_id="<id>", test_phase_id="<id>", matrix_id="<id>", graph_attachment_upload={
        "file_name": "signature.jpg",
    })
...
with SDK(
    ...
    res = sdk.test_forms.get_matrix_attachments(test_form_id="<id>", test_phase_id="<id>", matrix_id="<id>")
...
with SDK(
    ...
    res = sdk.test_forms.get_matrix_attachment_by_id(test_form_id="<id>", test_phase_id="<id>", matrix_id="<id>", attachment_id="<id>")
...
with SDK(
    ...
    res = sdk.test_forms.matrix_attachment_download_by_id(test_form_id="<id>", test_phase_id="<id>", matrix_id="<id>", attachment_id="<id>")
...
with SDK(
    ...
    res = sdk.test_forms.get_samples(test_form_id="<id>", test_phase_id="<id>", matrix_id="<id>", dollar_expand="?$expand=relationships\n")
...
with SDK(
    ...
    res = sdk.test_forms.create_sample(test_form_id="<id>", test_phase_id="<id>", matrix_id="<id>", matrix_sample={
        "data_values": [
            {
...
with SDK(
    ...
    res = sdk.test_forms.sample_insertion(test_form_id="<id>", test_phase_id="<id>", matrix_id="<id>", request_body=[
        {
            "data_values": [
                {
                    "column": "6d870cd1-7bbe-4b14-b85d-f152913b068c",
...
with SDK(
    ...
    res = sdk.test_forms.sample_update(test_form_id="<id>", test_phase_id="<id>", matrix_id="<id>", request_body=[
        {
            "data_values": [
                {
                    "column": "6d870cd1-7bbe-4b14-b85d-f152913b068c",
...
with SDK(
    ...
    res = sdk.test_forms.get_sample_attachments(test_form_id="<id>", test_phase_id="<id>", matrix_id="<id>", sample_id="<id>")
