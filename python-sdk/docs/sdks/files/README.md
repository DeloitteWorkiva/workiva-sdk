...
with SDK(
    ...
    res = sdk.files.get_file_permissions(file_id="<id>", dollar_maxpagesize=1000, dollar_next="JTI0bGltaXQ9MTAwJiUyNG9mZnNldD0xMDA")
...
with SDK(
    ...
    res = sdk.files.get_files(dollar_maxpagesize=1000, dollar_next="JTI0bGltaXQ9MTAwJiUyNG9mZnNldD0xMDA")
...
with SDK(
    ...
    res = sdk.files.get_trashed_files(dollar_maxpagesize=1000, dollar_next="JTI0bGltaXQ9MTAwJiUyNG9mZnNldD0xMDA")
